...
public class Drink {
	...
	// For testing
	public Drink(int id, String name, String manufacturer, int yearIntroduced, int volume, boolean fizzy,
	...
	// For creating
	public Drink(String name, String manufacturer, int yearIntroduced, int volume, boolean fizzy,
			boolean containsSugar) {
		super();
		this.name = name;
		this.manufacturer = manufacturer;
	...
	public String toString() {
		return "Drink [id=" + id + ", name=" + name + ", manufacturer=" + manufacturer + ", yearIntroduced="
				+ yearIntroduced + ", volume=" + volume + ", fizzy=" + fizzy + ", containsSugar=" + containsSugar + "]";
	}

	@Override
	public int hashCode() {
		return Objects.hash(containsSugar, fizzy, manufacturer, name, volume, yearIntroduced);
	}
	...
	public boolean equals(Object obj) {
		...
		return containsSugar == other.containsSugar && fizzy == other.fizzy
