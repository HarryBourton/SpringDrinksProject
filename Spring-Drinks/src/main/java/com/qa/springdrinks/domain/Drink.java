...
public class Drink {
	...
	//For creating
	public Drink(String name, String manufacturer, int yearIntroduced, int volume, boolean isFizzy, boolean containsSugar) {
		super();
		this.name = name;
		this.manufacturer = manufacturer;
		this.yearIntroduced = yearIntroduced;
	...
	@Override
	public int hashCode() {
		return Objects.hash(containsSugar, id, isFizzy, manufacturer, name, volume, yearIntroduced);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return containsSugar == other.containsSugar && id == other.id && isFizzy == other.isFizzy
